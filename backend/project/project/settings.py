...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',  # додано
...
# CORS settings
CORS_ALLOW_ALL_ORIGINS = True  # Дозволити всі джерела. Змініть на CORS_ALLOWED_ORIGINS для специфічних доменів.
CORS_ALLOW_CREDENTIALS = True  # Дозволити облікові дані
